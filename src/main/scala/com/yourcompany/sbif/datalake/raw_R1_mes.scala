 ...
 */
class raw_R1_mes(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_DataLake(huemulBigDataGov, Control) with Serializable  {
   this.LogicalName = "sbif_R1_mes"
...
object raw_R1_mes_test {
  ...
  def main(args : Array[String]) {
    ...
    val DF_RAW =  new raw_R1_mes(huemulBigDataGov, Control)
