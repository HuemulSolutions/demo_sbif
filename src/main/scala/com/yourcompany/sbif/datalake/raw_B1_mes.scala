...
class raw_B1_mes(huemulBigDataGov: huemul_BigDataGovernance, Control: huemul_Control) extends huemul_DataLake(huemulBigDataGov, Control) with Serializable  {
   ...
   CurrentSetting.FileName = "b1{{YYYY}}{{MM}}{{Cod_Banco}}.txt"
   ...
   //Forma detallada
   CurrentSetting.DataSchemaConf.AddColumns("planCuenta_id", "planCuenta_id", StringType, "Código contable. Es un campo de 7 digitos que identifica el concepto contable que se describe en el archivo Modelo-MB1.txt.")
   CurrentSetting.DataSchemaConf.AddColumns("b1_Monto_clp", "monto_clp", DecimalType(20,2), "Monto Moneda Chilena No Reajustable (Valor en millones de pesos chilenos)")
   CurrentSetting.DataSchemaConf.AddColumns("b1_Monto_ipc", "monto_ipc", DecimalType(20,2), "Monto Moneda reajustable por factores de IPC (Valor en millones de pesos chilenos)")
   CurrentSetting.DataSchemaConf.AddColumns("b1_Monto_tdc", "monto_tdc", DecimalType(20,2), "Monto Moneda reajustable por Tipo de Cambio (Valor en millones de pesos chilenos)")
   CurrentSetting.DataSchemaConf.AddColumns("b1_Monto_tdcb", "monto_tdcb", DecimalType(20,2), "Monto en Moneda Extranjera de acuerdo al tipo de cambio de representación contable usado por el banco (Valor en millones de pesos chilenos)")
