...
```shell
spark-submit --master local --jars huemul-bigdatagovernance-2.5.jar,huemul-sql-decode-1.0.jar,demo_settings-2.5.jar,demo_catalogo-2.5.jar,postgresql-9.4.1212.jar --class com.yourcompany.sbif.process_mensual  demo_sbif-2.5.jar environment=production,ano=2018,mes=6
```
