...
```shell
spark-submit --master local --jars huemul-bigdatagovernance-2.3.jar,huemul-sql-decode-1.0.jar,demo_settings-2.3.jar,demo_catalogo-2.3.jar,postgresql-9.4.1212.jar --class com.yourcompany.sbif.process_mensual  demo_sbif-2.3.jar environment=production,ano=2018,mes=6
```
